...
argglobal
%argdel
$argadd ~/work/dragino-packages/dragino-gw-fwd/src/fwd/src/mqtt_serv.c
edit fwd/src/fwd.c
...
exe 'vert 4resize ' . ((&columns * 140 + 86) / 172)
argglobal
enew
file NERD_tree_1
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 232 - ((11 * winheight(0) + 6) / 12)
...
wincmd w
argglobal
if bufexists("fwd/src/mqtt_serv.c") | buffer fwd/src/mqtt_serv.c | else | edit fwd/src/mqtt_serv.c | endif
map <buffer> ,  :make
nnoremap <buffer> ,cr :cs kill 0:cs add cscope.out
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("fwd/inc/gwcfg.h") | buffer fwd/inc/gwcfg.h | else | edit fwd/inc/gwcfg.h | endif
map <buffer> ,  :make
nnoremap <buffer> ,cr :cs kill 0:cs add cscope.out
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 172 - ((0 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
172
...
exe 'vert 4resize ' . ((&columns * 140 + 86) / 172)
tabnext 1
badd +167 fwd/src/mqtt_serv.c
badd +43 fwd/inc/mqtt_service.h
badd +146 fwd/inc/gwcfg.h
badd +509 fwd/src/gwcfg.c
badd +189 fwd/src/gwtraf_serv.c
badd +1 libmqtt/MQTTErrors.h
badd +21 libmqtt/MQTTClient.h
badd +366 fwd/src/semtech_serv.c
badd +570 fwd/src/fwd.c
badd +373 fwd/src/pkt_serv.c
badd +162 fwd/src/service.c
badd +72 fwd/inc/service.h
badd +26 fwd/src/utilities.c
badd +111 fwd/inc/utilities.h
badd +49 fwd/inc/fwd.h
