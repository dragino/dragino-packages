...
@brief model types that can be found on the LoRa Gateway
*/
enum lgw_model_type_e {
    LGW_MODEL_TYPE_NONE,
    LGW_MODEL_TYPE_SX1301,
    LGW_MODEL_TYPE_SX1302,
    LGW_MODEL_TYPE_SX1308,
    LGW_MODEL_TYPE_LG01,
    LGW_MODEL_TYPE_LG02
};
...
struct lgw_conf_lbt_s {
    ...
    bool                        isftdi;             /*!> use FTDI device or not */
