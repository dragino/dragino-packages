...
static const uint8_t ifmod_config[LGW_IF_CHAIN_NB] = LGW_IFMODEM_CONFIG;
...
static char	spidev_path[64] = "/dev/spidev1.0";
...
static int load_firmware(uint8_t target, uint8_t *firmware, uint16_t size) {
    ...
    lgw_sx1301_reg_w(reg_rst, 1);

    /* set mux to access MCU program RAM and set address to 0 */
    lgw_sx1301_reg_w(reg_sel, 0);
    lgw_sx1301_reg_w(LGW_MCU_PROM_ADDR, 0);

    /* write the program in one burst */
    lgw_sx1301_reg_wb(LGW_MCU_PROM_DATA, firmware, size);

    /* Read back firmware code for check */
    lgw_sx1301_reg_r( LGW_MCU_PROM_DATA, &dummy ); /* bug workaround */
    lgw_sx1301_reg_rb( LGW_MCU_PROM_DATA, fw_check, size );
...
static void lgw_constant_adjust(void) {
    ...
    /* I/Q path setup */
    // lgw_sx1301_reg_w(LGW_RX_INVERT_IQ,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_MODEM_INVERT_IQ,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CHIRP_INVERT_RX,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_RX_EDGE_SELECT,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_INVERT_IQ,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_DC_NOTCH_EN,1); /* default 1 */
    lgw_sx1301_reg_w(LGW_RSSI_BB_FILTER_ALPHA,6); /* default 7 */
    lgw_sx1301_reg_w(LGW_RSSI_DEC_FILTER_ALPHA,7); /* default 5 */
    lgw_sx1301_reg_w(LGW_RSSI_CHANN_FILTER_ALPHA,7); /* default 8 */
    lgw_sx1301_reg_w(LGW_RSSI_BB_DEFAULT_VALUE,23); /* default 32 */
    lgw_sx1301_reg_w(LGW_RSSI_CHANN_DEFAULT_VALUE,85); /* default 100 */
    lgw_sx1301_reg_w(LGW_RSSI_DEC_DEFAULT_VALUE,66); /* default 100 */
    lgw_sx1301_reg_w(LGW_DEC_GAIN_OFFSET,7); /* default 8 */
    lgw_sx1301_reg_w(LGW_CHAN_GAIN_OFFSET,6); /* default 7 */

    /* Correlator setup */
    // lgw_sx1301_reg_w(LGW_CORR_DETECT_EN,126); /* default 126 */
    // lgw_sx1301_reg_w(LGW_CORR_NUM_SAME_PEAK,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_MAC_GAIN,5); /* default 5 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF6,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF7,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF8,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF9,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF10,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF11,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SAME_PEAKS_OPTION_SF12,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF6,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF7,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF8,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF9,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF10,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF11,4); /* default 4 */
    // lgw_sx1301_reg_w(LGW_CORR_SIG_NOISE_RATIO_SF12,4); /* default 4 */

    /* LoRa 'multi' demodulators setup */
    // lgw_sx1301_reg_w(LGW_PREAMBLE_SYMB1_NB,10); /* default 10 */
    // lgw_sx1301_reg_w(LGW_FREQ_TO_TIME_INVERT,29); /* default 29 */
    // lgw_sx1301_reg_w(LGW_FRAME_SYNCH_GAIN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_SYNCH_DETECT_TH,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_ZERO_PAD,0); /* default 0 */
    lgw_sx1301_reg_w(LGW_SNR_AVG_CST,3); /* default 2 */
    if (lorawan_public) { /* LoRa network */
        lgw_sx1301_reg_w(LGW_FRAME_SYNCH_PEAK1_POS,3); /* default 1 */
        lgw_sx1301_reg_w(LGW_FRAME_SYNCH_PEAK2_POS,4); /* default 2 */
    } else { /* private network */
        lgw_sx1301_reg_w(LGW_FRAME_SYNCH_PEAK1_POS,1); /* default 1 */
        lgw_sx1301_reg_w(LGW_FRAME_SYNCH_PEAK2_POS,2); /* default 2 */
    }

    // lgw_sx1301_reg_w(LGW_PREAMBLE_FINE_TIMING_GAIN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_ONLY_CRC_EN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_PAYLOAD_FINE_TIMING_GAIN,2); /* default 2 */
    // lgw_sx1301_reg_w(LGW_TRACKING_INTEGRAL,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_ADJUST_MODEM_START_OFFSET_RDX8,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_ADJUST_MODEM_START_OFFSET_SF12_RDX4,4092); /* default 4092 */
    // lgw_sx1301_reg_w(LGW_MAX_PAYLOAD_LEN,255); /* default 255 */

    /* LoRa standalone 'MBWSSF' demodulator setup */
    // lgw_sx1301_reg_w(LGW_MBWSSF_PREAMBLE_SYMB1_NB,10); /* default 10 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_FREQ_TO_TIME_INVERT,29); /* default 29 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_FRAME_SYNCH_GAIN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_SYNCH_DETECT_TH,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_ZERO_PAD,0); /* default 0 */
    if (lorawan_public) { /* LoRa network */
        lgw_sx1301_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK1_POS,3); /* default 1 */
        lgw_sx1301_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK2_POS,4); /* default 2 */
    } else {
        lgw_sx1301_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK1_POS,1); /* default 1 */
        lgw_sx1301_reg_w(LGW_MBWSSF_FRAME_SYNCH_PEAK2_POS,2); /* default 2 */
    }
    // lgw_sx1301_reg_w(LGW_MBWSSF_ONLY_CRC_EN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_PAYLOAD_FINE_TIMING_GAIN,2); /* default 2 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_PREAMBLE_FINE_TIMING_GAIN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_TRACKING_INTEGRAL,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_MBWSSF_AGC_FREEZE_ON_DETECT,1); /* default 1 */

    /* Improvement of reference clock frequency error tolerance */
    lgw_sx1301_reg_w(LGW_ADJUST_MODEM_START_OFFSET_RDX4, 1); /* default 0 */
    lgw_sx1301_reg_w(LGW_ADJUST_MODEM_START_OFFSET_SF12_RDX4, 4094); /* default 4092 */
    lgw_sx1301_reg_w(LGW_CORR_MAC_GAIN, 7); /* default 5 */

    /* FSK datapath setup */
    lgw_sx1301_reg_w(LGW_FSK_RX_INVERT,1); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_MODEM_INVERT_IQ,1); /* default 0 */

    /* FSK demodulator setup */
    lgw_sx1301_reg_w(LGW_FSK_RSSI_LENGTH,4); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_PKT_MODE,1); /* variable length, default 0 */
    lgw_sx1301_reg_w(LGW_FSK_CRC_EN,1); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_DCFREE_ENC,2); /* default 0 */
    // lgw_sx1301_reg_w(LGW_FSK_CRC_IBM,0); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_ERROR_OSR_TOL,10); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_PKT_LENGTH,255); /* max packet length in variable length mode */
    // lgw_sx1301_reg_w(LGW_FSK_NODE_ADRS,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_FSK_BROADCAST,0); /* default 0 */
    // lgw_sx1301_reg_w(LGW_FSK_AUTO_AFC_ON,0); /* default 0 */
    lgw_sx1301_reg_w(LGW_FSK_PATTERN_TIMEOUT_CFG,128); /* sync timeout (allow 8 bytes preamble + 8 bytes sync word, default 0 */

    /* TX general parameters */
    lgw_sx1301_reg_w(LGW_TX_START_DELAY, TX_START_DELAY_DEFAULT); /* default 0 */

    /* TX LoRa */
    // lgw_sx1301_reg_w(LGW_TX_MODE,0); /* default 0 */
    lgw_sx1301_reg_w(LGW_TX_SWAP_IQ,1); /* "normal" polarity; default 0 */
    if (lorawan_public) { /* LoRa network */
        lgw_sx1301_reg_w(LGW_TX_FRAME_SYNCH_PEAK1_POS,3); /* default 1 */
        lgw_sx1301_reg_w(LGW_TX_FRAME_SYNCH_PEAK2_POS,4); /* default 2 */
    } else { /* Private network */
        lgw_sx1301_reg_w(LGW_TX_FRAME_SYNCH_PEAK1_POS,1); /* default 1 */
        lgw_sx1301_reg_w(LGW_TX_FRAME_SYNCH_PEAK2_POS,2); /* default 2 */
    }

    /* TX FSK */
    // lgw_sx1301_reg_w(LGW_FSK_TX_GAUSSIAN_EN,1); /* default 1 */
    lgw_sx1301_reg_w(LGW_FSK_TX_GAUSSIAN_SELECT_BT,2); /* Gaussian filter always on TX, default 0 */
    // lgw_sx1301_reg_w(LGW_FSK_TX_PATTERN_EN,1); /* default 1 */
    // lgw_sx1301_reg_w(LGW_FSK_TX_PREAMBLE_SEQ,0); /* default 0 */
...
int lgw_board_sx1301_setconf(struct lgw_conf_board_s *conf) {
	...
	strcpy(spidev_path, conf->spidev_path);
...
int lgw_sx1301_start(void) {
    ...
    reg_stat = lgw_sx1301_connect(spidev_path);
    ...
    /* gate clocks */
    lgw_sx1301_reg_w(LGW_GLOBAL_EN, 0);
    lgw_sx1301_reg_w(LGW_CLK32M_EN, 0);

    /* switch on and reset the radios (also starts the 32 MHz XTAL) */
    lgw_sx1301_reg_w(LGW_RADIO_A_EN,1);
    lgw_sx1301_reg_w(LGW_RADIO_B_EN,1);
    wait_ms(500); /* TODO: optimize */
    lgw_sx1301_reg_w(LGW_RADIO_RST,1);
    wait_ms(5);
    lgw_sx1301_reg_w(LGW_RADIO_RST,0);
    ...
    lgw_sx1301_reg_w(LGW_GPIO_MODE,31); /* Set all GPIOs as output */
    lgw_sx1301_reg_w(LGW_GPIO_SELECT_OUTPUT,2);

    /* Configure LBT */
    if (lbt_is_enabled() == true) {
        lgw_sx1301_reg_w(LGW_CLK32M_EN, 1);
        /*
        i = lbt_setup();
    ...
    /* Enable clocks */
    lgw_sx1301_reg_w(LGW_GLOBAL_EN, 1);
    lgw_sx1301_reg_w(LGW_CLK32M_EN, 1);
    ...
    */
    ...
    lgw_sx1301_reg_w(LGW_FORCE_HOST_RADIO_CTRL, 0); /* gives to AGC MCU the control of the radios */
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, cal_cmd); /* send calibration configuration word */
    lgw_sx1301_reg_w(LGW_MCU_RST_1, 0);

    /* Check firmware version */
    lgw_sx1301_reg_w(LGW_DBG_AGC_MCU_RAM_ADDR, FW_VERSION_ADDR);
    lgw_sx1301_reg_r(LGW_DBG_AGC_MCU_RAM_DATA, &read_val);
    ...
    lgw_sx1301_reg_w(LGW_PAGE_REG, 3); /* Calibration will start on this condition as soon as MCU can talk to concentrator registers */
    lgw_sx1301_reg_w(LGW_EMERGENCY_FORCE_HOST_CTRL, 0); /* Give control of concentrator registers to MCU */

    /* Wait for calibration to end */
    DEBUG_PRINTF("Note: calibration started (time: %u ms)\n", cal_time);
    wait_ms(cal_time); /* Wait for end of calibration */
    lgw_sx1301_reg_w(LGW_EMERGENCY_FORCE_HOST_CTRL, 1); /* Take back control */

    /* Get calibration status */
    lgw_sx1301_reg_r(LGW_MCU_AGC_STATUS, &read_val);
    ...
    */
    ...
    for(i=0; i<=7; ++i) {
        lgw_sx1301_reg_w(LGW_DBG_AGC_MCU_RAM_ADDR, 0xA0+i);
        lgw_sx1301_reg_r(LGW_DBG_AGC_MCU_RAM_DATA, &read_val);
        cal_offset_a_i[i] = (int8_t)read_val;
        lgw_sx1301_reg_w(LGW_DBG_AGC_MCU_RAM_ADDR, 0xA8+i);
        lgw_sx1301_reg_r(LGW_DBG_AGC_MCU_RAM_DATA, &read_val);
        cal_offset_a_q[i] = (int8_t)read_val;
        lgw_sx1301_reg_w(LGW_DBG_AGC_MCU_RAM_ADDR, 0xB0+i);
        lgw_sx1301_reg_r(LGW_DBG_AGC_MCU_RAM_DATA, &read_val);
        cal_offset_b_i[i] = (int8_t)read_val;
        lgw_sx1301_reg_w(LGW_DBG_AGC_MCU_RAM_ADDR, 0xB8+i);
        lgw_sx1301_reg_r(LGW_DBG_AGC_MCU_RAM_DATA, &read_val);
    ...
    lgw_sx1301_reg_w(LGW_FREQ_TO_TIME_DRIFT, x); /* default 9 */

    x = 4096000000 / (rf_rx_freq[0] >> 3); /* dividend: (16*2048*1000000) >> 3, rescaled to avoid 32b overflow */
    x = ( x > 63 ) ? 63 : x; /* saturation */
    lgw_sx1301_reg_w(LGW_MBWSSF_FREQ_TO_TIME_DRIFT, x); /* default 36 */
    ...
    /*
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, radio_select);
    ...
    */
    ...
    lgw_sx1301_reg_w(LGW_IF_FREQ_0, IF_HZ_TO_REG(if_freq[0])); /* default -384 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_1, IF_HZ_TO_REG(if_freq[1])); /* default -128 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_2, IF_HZ_TO_REG(if_freq[2])); /* default 128 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_3, IF_HZ_TO_REG(if_freq[3])); /* default 384 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_4, IF_HZ_TO_REG(if_freq[4])); /* default -384 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_5, IF_HZ_TO_REG(if_freq[5])); /* default -128 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_6, IF_HZ_TO_REG(if_freq[6])); /* default 128 */
    lgw_sx1301_reg_w(LGW_IF_FREQ_7, IF_HZ_TO_REG(if_freq[7])); /* default 384 */

    lgw_sx1301_reg_w(LGW_CORR0_DETECT_EN, (if_enable[0] == true) ? lora_multi_sfmask[0] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR1_DETECT_EN, (if_enable[1] == true) ? lora_multi_sfmask[1] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR2_DETECT_EN, (if_enable[2] == true) ? lora_multi_sfmask[2] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR3_DETECT_EN, (if_enable[3] == true) ? lora_multi_sfmask[3] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR4_DETECT_EN, (if_enable[4] == true) ? lora_multi_sfmask[4] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR5_DETECT_EN, (if_enable[5] == true) ? lora_multi_sfmask[5] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR6_DETECT_EN, (if_enable[6] == true) ? lora_multi_sfmask[6] : 0); /* default 0 */
    lgw_sx1301_reg_w(LGW_CORR7_DETECT_EN, (if_enable[7] == true) ? lora_multi_sfmask[7] : 0); /* default 0 */

    lgw_sx1301_reg_w(LGW_PPM_OFFSET, 0x60); /* as the threshold is 16ms, use 0x60 to enable ppm_offset for SF12 and SF11 @125kHz*/

    lgw_sx1301_reg_w(LGW_CONCENTRATOR_MODEM_ENABLE, 1); /* default 0 */

    /* configure LoRa 'stand-alone' modem (IF8) */
    lgw_sx1301_reg_w(LGW_IF_FREQ_8, IF_HZ_TO_REG(if_freq[8])); /* MBWSSF modem (default 0) */
    if (if_enable[8] == true) {
        lgw_sx1301_reg_w(LGW_MBWSSF_RADIO_SELECT, if_rf_chain[8]);
        switch(lora_rx_bw) {
            case BW_125KHZ: lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_BW, 0); break;
            case BW_250KHZ: lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_BW, 1); break;
            case BW_500KHZ: lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_BW, 2); break;
            default:
                DEBUG_PRINTF("ERROR~ UNEXPECTED VALUE %d IN SWITCH STATEMENT\n", lora_rx_bw);
                return LGW_HAL_ERROR;
        }
        switch(lora_rx_sf) {
            case DR_LORA_SF7: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 7); break;
            case DR_LORA_SF8: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 8); break;
            case DR_LORA_SF9: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 9); break;
            case DR_LORA_SF10: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 10); break;
            case DR_LORA_SF11: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 11); break;
            case DR_LORA_SF12: lgw_sx1301_reg_w(LGW_MBWSSF_RATE_SF, 12); break;
            default:
                DEBUG_PRINTF("ERROR~ UNEXPECTED VALUE %d IN SWITCH STATEMENT\n", lora_rx_sf);
                return LGW_HAL_ERROR;
        }
        lgw_sx1301_reg_w(LGW_MBWSSF_PPM_OFFSET, lora_rx_ppm_offset); /* default 0 */
        lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_ENABLE, 1); /* default 0 */
    } else {
        lgw_sx1301_reg_w(LGW_MBWSSF_MODEM_ENABLE, 0);
    }

    /* configure FSK modem (IF9) */
    lgw_sx1301_reg_w(LGW_IF_FREQ_9, IF_HZ_TO_REG(if_freq[9])); /* FSK modem, default 0 */
    lgw_sx1301_reg_w(LGW_FSK_PSIZE, fsk_sync_word_size-1);
    lgw_sx1301_reg_w(LGW_FSK_TX_PSIZE, fsk_sync_word_size-1);
    fsk_sync_word_reg = fsk_sync_word << (8 * (8 - fsk_sync_word_size));
    lgw_sx1301_reg_w(LGW_FSK_REF_PATTERN_LSB, (uint32_t)(0xFFFFFFFF & fsk_sync_word_reg));
    lgw_sx1301_reg_w(LGW_FSK_REF_PATTERN_MSB, (uint32_t)(0xFFFFFFFF & (fsk_sync_word_reg >> 32)));
    if (if_enable[9] == true) {
        lgw_sx1301_reg_w(LGW_FSK_RADIO_SELECT, if_rf_chain[9]);
        lgw_sx1301_reg_w(LGW_FSK_BR_RATIO, LGW_XTAL_FREQU/fsk_rx_dr); /* setting the dividing ratio for datarate */
        lgw_sx1301_reg_w(LGW_FSK_CH_BW_EXPO, fsk_rx_bw);
        lgw_sx1301_reg_w(LGW_FSK_MODEM_ENABLE, 1); /* default 0 */
    } else {
        lgw_sx1301_reg_w(LGW_FSK_MODEM_ENABLE, 0);
    }
    ...
    lgw_sx1301_reg_w(LGW_FORCE_HOST_RADIO_CTRL, 0);
    lgw_sx1301_reg_w(LGW_FORCE_HOST_FE_CTRL, 0);
    lgw_sx1301_reg_w(LGW_FORCE_DEC_FILTER_GAIN, 0);

    /* Get MCUs out of reset */
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, 0); /* MUST not be = to 1 or 2 at firmware init */
    lgw_sx1301_reg_w(LGW_MCU_RST_0, 0);
    lgw_sx1301_reg_w(LGW_MCU_RST_1, 0);
    ...
    lgw_sx1301_reg_w(LGW_DBG_ARB_MCU_RAM_ADDR, FW_VERSION_ADDR);
    lgw_sx1301_reg_r(LGW_DBG_ARB_MCU_RAM_DATA, &read_val);
    fw_version = (uint8_t)read_val;
    ...
    for (i = 0; i < txgain_lut.size; ++i) {
        lgw_sx1301_reg_w(LGW_RADIO_SELECT, AGC_CMD_WAIT); /* start a transaction */
        wait_ms(1);
        load_val = txgain_lut.lut[i].mix_gain + (16 * txgain_lut.lut[i].dac_gain) + (64 * txgain_lut.lut[i].pa_gain);
        lgw_sx1301_reg_w(LGW_RADIO_SELECT, load_val);
        wait_ms(1);
        lgw_sx1301_reg_r(LGW_MCU_AGC_STATUS, &read_val);
        if (read_val != (0x30 + i)) {
            DEBUG_PRINTF("ERROR~ AGC FIRMWARE INITIALIZATION FAILURE, STATUS 0x%02X\n", (uint8_t)read_val);
    ...
    if (txgain_lut.size < TX_GAIN_LUT_SIZE_MAX) {
        lgw_sx1301_reg_w(LGW_RADIO_SELECT, AGC_CMD_WAIT);
        wait_ms(1);
    ...
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, AGC_CMD_WAIT);
    wait_ms(1);
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, 3);
    wait_ms(1);
    lgw_sx1301_reg_r(LGW_MCU_AGC_STATUS, &read_val);
    if (read_val != 0x33) {
        DEBUG_PRINTF("ERROR~ AGC FIRMWARE INITIALIZATION FAILURE, STATUS 0x%02X\n", (uint8_t)read_val);
    ...
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, AGC_CMD_WAIT);
    wait_ms(1);
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, 0);
    wait_ms(1);
    lgw_sx1301_reg_r(LGW_MCU_AGC_STATUS, &read_val);
    if (read_val != 0x30) {
        DEBUG_PRINTF("ERROR~ AGC FIRMWARE INITIALIZATION FAILURE, STATUS 0x%02X\n", (uint8_t)read_val);
    ...
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, AGC_CMD_WAIT);
    wait_ms(1);
    lgw_sx1301_reg_w(LGW_RADIO_SELECT, radio_select); /* Load intended value of RADIO_SELECT */
    wait_ms(1);
...
int lgw_sx1301_receive(uint8_t max_pkt, struct lgw_pkt_rx_s *pkt_data) {
    ...
    for (nb_pkt_fetch = 0; nb_pkt_fetch < max_pkt; ++nb_pkt_fetch) {
        ...
        lgw_sx1301_reg_rb(LGW_RX_PACKET_DATA_FIFO_NUM_STORED, buff, 5);
        ...
        lgw_sx1301_reg_rb(LGW_RX_DATA_BUF_DATA, buff, sz+RX_METADATA_NB);
        ...
        p->rssic = (float)buff[sz+5] + rf_rssi_offset[p->rf_chain];
        ...
        /* advance packet FIFO */
        lgw_sx1301_reg_w(LGW_RX_PACKET_DATA_FIFO_NUM_STORED, 0);
    }
...
int lgw_sx1301_send(struct lgw_pkt_tx_s *pkt_data) {
    ...
    if (pkt_data->rf_chain == 0) { /* use radio A calibration table */
        lgw_sx1301_reg_w(LGW_TX_OFFSET_I, cal_offset_a_i[target_mix_gain - 8]);
        lgw_sx1301_reg_w(LGW_TX_OFFSET_Q, cal_offset_a_q[target_mix_gain - 8]);
    } else { /* use radio B calibration table */
        lgw_sx1301_reg_w(LGW_TX_OFFSET_I, cal_offset_b_i[target_mix_gain - 8]);
        lgw_sx1301_reg_w(LGW_TX_OFFSET_Q, cal_offset_b_q[target_mix_gain - 8]);
    }

    /* Set digital gain from LUT */
    lgw_sx1301_reg_w(LGW_TX_GAIN, txgain_lut.lut[pow_index].dig_gain);
    ...
    lgw_sx1301_reg_w(LGW_TX_START_DELAY, tx_start_delay);
    ...
    lgw_abort_sx1301_tx(1);

    /* put metadata + payload in the TX data buffer */
    lgw_sx1301_reg_w(LGW_TX_DATA_BUF_ADDR, 0);
    lgw_sx1301_reg_wb(LGW_TX_DATA_BUF_DATA, buff, transfer_size);
    ...
    if (tx_allowed == true) {
        switch(pkt_data->tx_mode) {
            case IMMEDIATE:
                lgw_sx1301_reg_w(LGW_TX_TRIG_IMMEDIATE, 1);
                break;

            case TIMESTAMPED:
                lgw_sx1301_reg_w(LGW_TX_TRIG_DELAYED, 1);
                break;

            case ON_GPS:
                lgw_sx1301_reg_w(LGW_TX_TRIG_GPS, 1);
                break;
...
int lgw_sx1301_status(uint8_t rf_chain, uint8_t select, uint8_t *code) {
    ...
    if (select == TX_STATUS) {
        lgw_sx1301_reg_r(LGW_TX_STATUS, &read_value);
        if (lgw_is_started == false) {
            *code = TX_OFF;
...
int lgw_abort_sx1301_tx(uint8_t rf_chain) {
    ...
    i = lgw_sx1301_reg_w(LGW_TX_TRIG_ALL, 0);
