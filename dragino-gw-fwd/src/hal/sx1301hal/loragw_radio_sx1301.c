...
void sx125x_write(uint8_t channel, uint8_t addr, uint8_t data) {
    ...
    lgw_sx1301_reg_w(reg_cs, 0);
    lgw_sx1301_reg_w(reg_add, 0x80 | addr); /* MSB at 1 for write operation */
    lgw_sx1301_reg_w(reg_dat, data);
    lgw_sx1301_reg_w(reg_cs, 1);
    lgw_sx1301_reg_w(reg_cs, 0);
...
uint8_t sx125x_read(uint8_t channel, uint8_t addr) {
    ...
    lgw_sx1301_reg_w(reg_cs, 0);
    lgw_sx1301_reg_w(reg_add, addr); /* MSB at 0 for read operation */
    lgw_sx1301_reg_w(reg_dat, 0);
    lgw_sx1301_reg_w(reg_cs, 1);
    lgw_sx1301_reg_w(reg_cs, 0);
    lgw_sx1301_reg_r(reg_rb, &read_value);
