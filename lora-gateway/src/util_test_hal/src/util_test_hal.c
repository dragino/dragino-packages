...
static uint8_t LOOPMAX = 32; /* tx and rx loop 32 times */
/* -------------------------------------------------------------------------- */
...
void usage(void) {
    ...
    printf( " -a <float> Radio A RX frequency in MHz, default: 868.5\n");
    printf( " -b <float> Radio B RX frequency in MHz, default: 868.9\n");
    printf( " -t <float> Radio TX frequency in MHz, default: 869.525\n");
    printf( " -c <int> LOOP count of RX and TX, default: 32\n");
    printf( " -r <int> Radio type (SX1255:1255, SX1257:1257, default: 1257)\n");
...
int main(int argc, char **argv)
{
    ...
    while ((i = getopt (argc, argv, "ha:b:t:c:r:k:")) != -1) {
        switch (i) {
            case 'h':
                usage();
                return -1;
    ...
    if ((fa == 0) || (fb == 0) || (ft == 0)) {
        printf("INFO: frequency input parameter set to default:\n");
        fa = 868500000;
        fb = 868900000;
        ft = 869525000;
        printf("  Radio A RX: %u\n", fa);
...
*/
    ...
    while ((quit_sig != 1) && (exit_sig != 1) && (loop_cnt < LOOPMAX)) {
        loop_cnt++;
