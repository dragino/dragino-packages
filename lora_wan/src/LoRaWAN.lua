...
s = m:section(NamedSection, "general", "LoRaWAN", translate("Server Settings"))
...
s = m:section(NamedSection, "radio", "LoRaWAN", translate("Radio Settings"))
local fre = s:option(Value, "frequency", translate("Frequency"))
fre.placeholder = "9 digits LoRa Frequency"
fre.datatype = "rangelength(9,9)"
