...
s = m:section(NamedSection, "mesh", "secn", translate("Mesh Setting"), "Mesh devices with the same group ID and AP wifi channel can communicate with each other")
...
local mesh_group_id = s:option(Value, "mesh_group", "<abbr title=\"Mesh Network Group ID\">Group ID</abbr>",translate("Input a number between 1 ~ 1099511627775"))
mesh_group_id.datatype='range("1","1099511627775")'
mesh_group_id.default='99999999'

s = m:section(NamedSection, "mesh", "secn", translate("Mesh Gateway"))
