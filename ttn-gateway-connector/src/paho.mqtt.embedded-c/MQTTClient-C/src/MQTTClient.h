 ...
 * @param client
 */
DLLExport void MQTTClientDestroy(MQTTClient *client);
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribe(MQTTClient *client, const char *topicFilter, enum QoS, messageHandler, void *arg);
